...
public class CartaoProxy implements com.exemplo.ws.Cartao {
  private String _endpoint = null;
  private com.exemplo.ws.Cartao cartao = null;
  ...
  private void _initCartaoProxy() {
    try {
      cartao = (new com.exemplo.ws.CartaoServiceLocator()).getCartao();
      if (cartao != null) {
        if (_endpoint != null)
  ...
  public com.exemplo.ws.Cartao getCartao() {
    if (cartao == null)
      _initCartaoProxy();
    return cartao;
  }

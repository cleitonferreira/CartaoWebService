...
public class CartaoServiceLocator extends org.apache.axis.client.Service implements com.exemplo.ws.CartaoService {
    ...
    public com.exemplo.ws.Cartao getCartao(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.exemplo.ws.CartaoSoapBindingStub _stub = new com.exemplo.ws.CartaoSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.exemplo.ws.Cartao.class.isAssignableFrom(serviceEndpointInterface)) {
                com.exemplo.ws.CartaoSoapBindingStub _stub = new com.exemplo.ws.CartaoSoapBindingStub(new java.net.URL(Cartao_address), this);
                _stub.setPortName(getCartaoWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.exemplo.com", "CartaoService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.exemplo.com", "Cartao"));
        }
